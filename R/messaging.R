...
#' @param blocks An array of @family{Blocks} in the same format as described in the \href{https://api.slack.com/block-kit/building}{building blocks guide}.
#' @param attachments An array of legacy secondary attachments. We recommend you use blocks instead.
...
#' @family Messaging
#' @export
message_object <- function(text, blocks = NULL, attachments = NULL, thread_ts = NULL, mrkdown = NULL){
...
#' @param fields An array of field objects that get displayed in a table-like way (See the example above). For best results, include no more than 2-3 field objects. 
...
#' @param mrkdwn_in An array of field names that should be formatted by mrkdwn syntax. 
