...
#' @export
text.object <- function(type, text, emoji = NULL, verbatim = NULL){
...
#' 
#' @param title A plain_text-only \code{\link{text.object}} that defines the dialog's title. Maximum length for this field is 100 characters.
#' @param text 	A \code{\link{text.object}} that defines the explanatory text that appears in the confirm dialog. Maximum length for the text in this field is 300 characters.
#' @param confirm A plain_text-only \code{\link{text.object}} to define the text of the button that confirms the action. Maximum length for the text in this field is 30 characters.
#' @param deny A plain_text-only \code{\link{text.object}} to define the text of the button that cancels the action. Maximum length for the text in this field is 30 characters.
...
#' @export
confirm.object <- function(title, text, confirm, deny, style = NULL){
